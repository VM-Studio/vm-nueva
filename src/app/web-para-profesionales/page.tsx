...
export default function LandingWebParaProfesionales() {

  const services = [
    {
      title: "1. PERFIL PROFESIONAL ONLINE",
      subtitle: "Presencia Digital",
      description: "Tu web personal que transmite credibilidad y confianza. Formación, experiencia, especialidades y testimonios de tus pacientes o clientes para que te elijan a vos.",
      imageSrc: Software,
    },
    {
      title: "2. TURNOS Y CONSULTAS ONLINE",
      subtitle: "Agenda & Reservas",
      description: "Sistema de turnos online para que tus pacientes o clientes reserven directamente desde tu web. Menos llamados, más turnos confirmados y menos ausentes.",
      imageSrc: Google,
    },
    {
      title: "3. POSICIONADO EN GOOGLE",
      subtitle: "SEO para Profesionales",
      description: "Aparecés cuando buscan 'médico en [tu ciudad]' o 'abogado para [tu especialidad]'. SEO local para que nuevos pacientes y clientes te encuentren en Google.",
      imageSrc: Automatic,
    }
  ];
  ...
  const processSteps = [
    {
      ...
      description: "Te mostramos cómo quedaría tu web profesional con tu perfil, especialidades y sistema de turnos. Diseño adaptado a tu profesión y marca personal.",
      duration: "48 HORAS"
    },
    {
      number: "02",
      title: "Desarrollo y configuración",
      description: "Desarrollamos tu web, configuramos el sistema de turnos, cargamos tu perfil completo y optimizamos todo para Google.",
      duration: "1-2 SEMANAS"
    },
    {
      number: "03",
      title: "Soporte y actualizaciones",
      description: "Actualizamos tu web cuando lo necesitás: nuevas especialidades, cambios de horario, fotos o secciones nuevas. Soporte continuo disponible. (Opcional)",
      duration: "MENSUAL"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="max-w-2xl">
              ...
              <p className="text-base sm:text-xl md:text-2xl text-gray-600 mb-8 sm:mb-12 font-light">
                Diseñamos tu web profesional con turnos online, perfil de credenciales y optimizada para que nuevos pacientes o clientes te encuentren en Google.
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-gray-50 relative">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="mb-12 sm:mb-20">
            <span className="text-[11px] font-medium tracking-[0.2em] text-gray-500">[ WEB PARA PROFESIONALES ]</span>
            <h2 className="mt-4 text-4xl sm:text-5xl md:text-6xl font-light tracking-tight text-black">
              Web que <span className="font-medium bg-gradient-to-r from-gray-900 to-blue-600 bg-clip-text text-transparent">genera pacientes</span>
            </h2>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
            <div className="p-8 bg-gray-100 rounded-lg">
              ...
              <ul className="space-y-4">
                {["Solo conseguís pacientes por recomendación","Sin presencia en Google para nuevos clientes","Tu competencia aparece antes en búsquedas","Perdés consultas todos los días sin saberlo"].map((item, i) => (
            ...
            <div className="px-5 sm:px-8 py-4 bg-gray-900 border-blue-500 border text-white rounded-lg">
              <Link href="/" className="flex items-center mb-4">
                <Image width={60} height={60} src={Logo} alt="VM Studio - Web para Profesionales" />
              </Link>
              <ul className="space-y-4 pb-4">
                {[
                  "Nuevos pacientes y clientes desde Google",
                  "Turnos online 24/7 sin intermediarios",
                  "Perfil profesional que genera confianza",
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-white">
        <div className="max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 sm:mb-20">
            ...
            <h2 className="mt-4 text-4xl sm:text-5xl md:text-6xl font-light tracking-tight text-black">
              Todo sobre tu <span className="font-medium">web profesional</span>
            </h2>
          </div>
          <div className="space-y-1">
            {[
              { q: "¿Para qué tipo de profesionales diseñan webs?", a: "Para médicos, odontólogos, psicólogos, nutricionistas, abogados, contadores, arquitectos, diseñadores, coaches y cualquier profesional independiente." },
              { q: "¿La web incluye sistema de turnos online?", a: "Sí. Integramos un sistema de turnos online para que tus pacientes o clientes reserven directamente desde tu web, con confirmación automática por email o WhatsApp." },
              { q: "¿La web va a aparecer en Google?", a: "Sí. Optimizamos el SEO local para que aparezcas cuando buscan tu especialidad en tu ciudad. Ej: 'psicólogo en Palermo' o 'abogado laboral en Rosario'." },
              { q: "¿Cuánto tarda en estar lista?", a: "En general 1 a 2 semanas. Antes de empezar te mostramos una maqueta gratis en 48 horas con el diseño adaptado a tu profesión." },
              { q: "¿Puedo mostrar mi formación y certificaciones?", a: "Sí. Tu web incluye una sección de perfil profesional completa: formación, matrícula, especialidades, experiencia y testimonios de pacientes o clientes." },
              { q: "¿Qué diferencia hay con hacer una web yo solo?", a: "Una web profesional diseñada estratégicamente para convertir visitas en consultas genera muchos más resultados que una web genérica. Además nos encargamos de todo." },
            ].map((faq, i) => (
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="mt-8 text-[clamp(2rem,6vw,4rem)] font-light leading-[1.1] mb-8 text-black">
              <span className="block">Tu web profesional</span>
