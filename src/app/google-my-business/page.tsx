...
export default function LandingGoogleMyBusiness() {

  const services = [
    {
      title: "1. FICHA OPTIMIZADA",
      subtitle: "Google My Business",
      description: "Creamos o completamos tu ficha de Google My Business con toda la información, fotos y palabras clave para que aparezcas primero en las búsquedas locales.",
      imageSrc: Google,
    },
    {
      title: "2. SEO LOCAL AVANZADO",
      subtitle: "Posicionamiento Local",
      description: "Optimizamos tu presencia en Google Maps con estrategias de SEO local: reseñas, categorías, atributos y publicaciones que mejoran tu ranking mes a mes.",
      imageSrc: Software,
    },
    {
      title: "3. MÁS CLIENTES LOCALES",
      subtitle: "Resultados Medibles",
      description: "Más llamadas, más visitas a tu negocio y más consultas desde personas de tu zona que buscan exactamente lo que ofrecés. Resultados en 30 días.",
      imageSrc: Automatic,
    }
  ];
  ...
  const processSteps = [
    {
      number: "01",
      title: "Auditoría de tu ficha",
      description: "Analizamos el estado actual de tu presencia en Google Maps y te mostramos exactamente qué hay que mejorar para aparecer primero que tu competencia.",
      duration: "48 HORAS"
    },
    {
      number: "02",
      title: "Optimización completa",
      description: "Completamos y optimizamos tu ficha con toda la información, fotos profesionales, categorías, horarios, servicios y palabras clave locales.",
      duration: "1 SEMANA"
    },
    {
      number: "03",
      title: "Gestión y mejora continua",
      description: "Gestionamos tu ficha mes a mes: publicaciones, respuesta a reseñas, actualización de datos y estrategias para escalar posiciones. (Opcional)",
      duration: "MENSUAL"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="max-w-2xl">
              ...
              <h1 className="text-[2.4rem] sm:text-[clamp(2rem,7vw,4.5rem)] font-light leading-[1.05] sm:leading-[0.95] tracking-[-0.02em] mb-6 sm:mb-8">
                <span className="text-black">Posicionamos tu negocio en </span>
              ...
              <p className="text-base sm:text-xl md:text-2xl text-gray-600 mb-8 sm:mb-12 font-light">
                Optimizamos tu ficha de Google My Business para que aparezcas primero cuando buscan tus servicios en tu zona. Más llamadas, más clientes.
                <span className="block mt-4 text-black font-normal">
                  Auditoría gratis de tu ficha.
                </span>
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  "
                >
                  <span className="relative z-10">PEDIR AUDITORÍA GRATIS</span>
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-gray-50 relative">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="mb-12 sm:mb-20">
            <span className="text-[11px] font-medium tracking-[0.2em] text-gray-500">[ GOOGLE MY BUSINESS ]</span>
            <h2 className="mt-4 text-4xl sm:text-5xl md:text-6xl font-light tracking-tight text-black">
              Primero en <span className="font-medium bg-gradient-to-r from-gray-900 to-blue-600 bg-clip-text text-transparent">Google Maps</span>
            </h2>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
            <div className="p-8 bg-gray-100 rounded-lg">
              <h3 className="text-xl font-light mb-6 text-gray-500">Sin optimización</h3>
              <ul className="space-y-4">
                {["Tu competencia aparece antes en Maps","Ficha incompleta y sin reseñas","Sin fotos ni publicaciones actualizadas","Perdés clientes locales todos los días"].map((item, i) => (
            ...
            <div className="px-5 sm:px-8 py-4 bg-gray-900 border-blue-500 border text-white rounded-lg">
              <Link href="/" className="flex items-center mb-4">
                <Image width={60} height={60} src={Logo} alt="VM Studio - Google My Business" />
              </Link>
              <ul className="space-y-4 pb-4">
                {[
                  "Aparecés primero en Google Maps en tu zona",
                  "Ficha completa, con fotos y reseñas gestionadas",
                  "Publicaciones y actualizaciones mensuales",
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-white">
        <div className="max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 sm:mb-20">
            ...
            <h2 className="mt-4 text-4xl sm:text-5xl md:text-6xl font-light tracking-tight text-black">
              Todo sobre <span className="font-medium">Google Maps</span>
            </h2>
          </div>
          <div className="space-y-1">
            {[
              { q: "¿Qué es Google My Business?", a: "Es la ficha de tu negocio en Google Maps y en los resultados de búsqueda local. Cuando alguien busca 'plomero cerca mío' o 'restaurante en Palermo', las fichas optimizadas aparecen primero." },
              { q: "¿En cuánto tiempo se ven resultados?", a: "En general los primeros resultados se ven en 30 días. El posicionamiento mejora progresivamente mes a mes con la gestión continua." },
              { q: "¿Qué pasa si ya tengo una ficha creada?", a: "Perfecto. Tomamos control de tu ficha existente, la optimizamos completamente y mejoramos todos los aspectos que están impidiendo que aparezcas primero." },
              { q: "¿Necesito también una página web?", a: "No es obligatorio, pero una página web complementa enormemente el Google My Business. Podemos trabajar solo el GMB o combinarlo con el desarrollo de tu web." },
              { q: "¿Cómo se gestionan las reseñas negativas?", a: "Las respondemos de forma profesional para proteger tu reputación y al mismo tiempo implementamos estrategias para generar más reseñas positivas." },
              { q: "¿Funciona para cualquier tipo de negocio?", a: "Sí. Google My Business funciona para cualquier negocio local: restaurants, médicos, abogados, comercios, servicios para el hogar, gimnasios y más." },
            ].map((faq, i) => (
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="mt-8 text-[clamp(2rem,6vw,4rem)] font-light leading-[1.1] mb-8 text-black">
              <span className="block">Aparecé primero</span>
              <span className="block font-medium bg-gradient-to-r from-gray-900 to-blue-600 bg-clip-text text-transparent">en Google Maps.</span>
            </h2>
            <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto font-light mb-10 sm:mb-12">
              Pedí la auditoría gratis de tu ficha y en 48 horas te decimos exactamente qué hay que mejorar para aparecer primero.
